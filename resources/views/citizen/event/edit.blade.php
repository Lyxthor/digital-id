...
@section('title', 'Edit Citizen Event')
            ...
            <div class="flex justify-between items-end flex-wrap">
                <div class="breadcrumbs w-full text-sm mb-4">
                    <ul class="flex space-x-2">
                        ...
                        <li><a href="#" class="text-blue-500">Events</a></li>
                        <li>Edit Events</li>
                    </ul>
                </div>
                <div>
                    <div class="flex items-end gap-5">
                        <div>
                            <h2 class="text-lg font-bold capitalize mb-4">Citizen Form</h2>
                            <span class="text-xs mb-6 text-slate-500">Edit event</span>
                        </div>
                    </div>
                </div>
                <div>
